...
<!-- page-title -->
        <div class="tf-page-title">
            <div class="container-full">
                <div class="heading text-center">افزودن آدرس </div>
            </div>
        </div>
        <!-- /page-title -->
                ...
                <div class="row">
                    <div class="col-lg-3">
                        <ul class="my-account-nav">
                            ...
                            <li><span class="my-account-nav-item active">افزودن آدرس </span></li>
                    ...
                    <div class="col-lg-9">
                        <div class="my-account-content account-edit">
                            <div class="">
                                <form class="" id="form-password-change"  method="post" action="{{route('addresses.store')}}">
                                    @csrf
                                    <div class="tf-field style-1 mb_15">
                                        <input class="tf-field-input tf-input" value="{{old('title')}}" type="text" id="property1" name="title">
                                        <label class="tf-field-label fw-4 text_black-2" for="property1">عنوان</label>
                                    </div>
                                    <div class="tf-field style-1 mb_15">
                                        <textarea class="tf-field-input tf-input" id="property2" name="body">{{old('body')}}</textarea>
                                        <label class="tf-field-label fw-4 text_black-2" for="property2">آدرس</label>
                                    </div>
                                    <select-city-component></select-city-component>
                                    <div class="tf-field style-1 mb_30">
                                        <input class="tf-field-input tf-input" value="{{old('phone')}}" type="text" id="property5" name="phone">
                                        <label class="tf-field-label fw-4 text_black-2" for="property5">تلفن</label>
                                    </div>
                                    <div class="tf-field style-1 mb_30">
                                        <input class="tf-field-input tf-input" value="{{old('postCode')}}" type="text" id="property5" name="postCode">
