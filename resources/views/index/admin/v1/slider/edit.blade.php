                        ...
                        <div class="card dark:bg-zinc-800 dark:border-zinc-600">
                            ...
                            <div class="card-body">
                                <div class="mb-4">
                                    ...
                                    <input name="title" value="{{$slide->title}}" class="w-full rounded border-gray-100 placeholder:text-sm focus:border focus:border-violet-500 focus:ring-0 dark:bg-zinc-700/50 dark:border-zinc-600 dark:placeholder:text-zinc-100 dark:text-zinc-100" type="text" placeholder="کفش" id="example-text-input">
                                </div>
                                <div class="mb-4">
                                    <label for="example-text-input" class="block font-medium text-gray-700 dark:text-gray-100 mb-2">متن اصلی</label>
                                    <input name="description" value="{{$slide->description}}" class="w-full rounded border-gray-100 placeholder:text-sm focus:border focus:border-violet-500 focus:ring-0 dark:bg-zinc-700/50 dark:border-zinc-600 dark:placeholder:text-zinc-100 dark:text-zinc-100" type="text" placeholder="فقط حروف انگلیسی" id="example-text-input">
                                </div>
                                <div class="mb-4">
                                    <label for="example-text-input" class="block font-medium text-gray-700 dark:text-gray-100 mb-2">لینک</label>
                                    <input name="link" value="{{$slide->link}}" class="w-full rounded border-gray-100 placeholder:text-sm focus:border focus:border-violet-500 focus:ring-0 dark:bg-zinc-700/50 dark:border-zinc-600 dark:placeholder:text-zinc-100 dark:text-zinc-100" type="text" placeholder="فقط حروف انگلیسی" id="example-text-input">
                                </div>
                                <div class="mt-8">
                                        ...
                                        <div class="col-span-12 lg:col-span-4">
                                            <div class="mb-3">
                                                ...
                                                <select name="status" >
                                                    ...
                                                    <option @if($slide->status==0)selected @endif value="0">غیرفعال</option>
                                                    <option @if($slide->status==1)selected @endif value="1">فعال</option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="hidden" name="image_id" id="slide-image" value="{{$slide->image->id}}">
                                    <div id="photo" class="dropzone" ></div>
                                    <div class="=row">
                                    </div>
                                    <div class="col-sm-3" id="updated_photo_{{$slide->image->id}}">
                                        <img class="img-responsive" src="{{asset('storage/photos/'.$slide->image->path)}}">
                                        <button type="button" class="btn btn-danger" onclick="removeImages({{$slide->image->id}})">حذف</button>
                                    </div>
                                </div>
                                <div class="mt-8">
                                    <div class="grid grid-cols-12 gap-5">
