            ...
            <div class="container-fluid px-[0.625rem]">
                ...
                <div class="grid grid-cols-1 mb-5">
                    <div class="flex items-center justify-between">
                        <h4 class="mb-sm-0 text-lg font-semibold grow text-gray-800 dark:text-gray-100">افزودن گروه ویژگی جدید</h4>
                            ...
                            <ol class="inline-flex items-center space-x-1 ltr:md:space-x-3 rtl:md:space-x-0">
                                ...
                                <li>
                                    <div class="flex items-center">
                                        ...
                                        <a href="{{route('attribute-groups.create')}}" class="ltr:ml-1 rtl:mr-1 text-sm font-medium text-gray-500 hover:text-gray-900 ltr:md:ml-2 rtl:md:mr-2 dark:text-gray-100 dark:hover:text-white">افزودن گروه ویژگی</a>
                                    </div>
                                </li>
                            </ol>
                        </nav>
                ...
                @endif
                <form method="POST" action="{{route('attribute-groups.store')}}" enctype="multipart/form-data">
                    @csrf
                                        ...
                                        <div class="col-span-12 lg:col-span-4">
                                            <div class="mb-3">
                                                ...
                                                <select name="type" >
                                                    ...
                                                    <option value="multipel">چندتایی</option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
