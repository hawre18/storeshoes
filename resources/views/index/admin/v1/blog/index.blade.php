            ...
            <div class="container-fluid px-[0.625rem]">
                ...
                <div class="grid grid-cols-1 mb-5">
                    <div class="flex items-center justify-between">
                        <h4 class="mb-sm-0 text-lg font-semibold grow text-gray-800 dark:text-gray-100">لیست خبرها</h4>
                            ...
                            <ol class="inline-flex items-center space-x-1 ltr:md:space-x-3 rtl:md:space-x-0">
                                ...
                                <li>
                                    <div class="flex items-center">
                                        ...
                                        <a href="#" class="ltr:ml-1 rtl:mr-1 text-sm font-medium text-gray-500 hover:text-gray-900 ltr:md:ml-2 rtl:md:mr-2 dark:text-gray-100 dark:hover:text-white">لیست خبرها</a>
                                    </div>
                                </li>
                            </ol>
                        </nav>
                                    ...
                                    <table class="table table-editable table-nowrap align-middle table-edits w-full text-right">
                                        ...
                                        @foreach($blogs as $row)
                                            <tr class="border-b border-gray-50 dark:border-zinc-600" data-id="1">
                                                ...
                                                <td class="p-3 dark:text-zinc-100" data-field="age">{!! substr($row->body,0,50) !!}</td>
                                                <td class="p-3 dark:text-zinc-100" data-field="age">{{$row->creator}}</td>
                                                ...
                                                <td class="p-3 dark:text-zinc-100" style="width: 100px">
                                                    <a class="btn btn-outline-secondary btn-sm edit" title="ویرایش" href="{{route('blogs.edit',$row->id)}}">
                                                        <i class="fas fa-pencil-alt"></i>
                                                    </a>
                                                    <a class="btn btn-outline-secondary btn-sm" title="حذف" href="{{route('blogs.delete',$row->id)}}">
