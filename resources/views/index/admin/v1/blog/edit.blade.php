            ...
            <div class="container-fluid px-[0.625rem]">
                ...
                <div class="grid grid-cols-1 mb-5">
                    <div class="flex items-center justify-between">
                        <h4 class="mb-sm-0 text-lg font-semibold grow text-gray-800 dark:text-gray-100">ویرایش خبر</h4>
                            ...
                            <ol class="inline-flex items-center space-x-1 ltr:md:space-x-3 rtl:md:space-x-0">
                                ...
                                <li>
                                    <div class="flex items-center">
                                        ...
                                        <a href="{{route('blogs.index')}}" class="ltr:ml-1 rtl:mr-1 text-sm font-medium text-gray-500 hover:text-gray-900 ltr:md:ml-2 rtl:md:mr-2 dark:text-gray-100 dark:hover:text-white">ویرایش خبر</a>
                                    </div>
                                </li>
                            </ol>
                        </nav>
                        ...
                        <div class="card dark:bg-zinc-800 dark:border-zinc-600">
                            ...
                            <div class="card-body">
                                <div class="mb-4">
                                    ...
                                    <input name="title" value="{{$blog->title}}" class="w-full rounded border-gray-100 placeholder:text-sm focus:border focus:border-violet-500 focus:ring-0 dark:bg-zinc-700/50 dark:border-zinc-600 dark:placeholder:text-zinc-100 dark:text-zinc-100" type="text" placeholder="کفش" id="example-text-input">
                                </div>
                                <div class="mb-4">
                                ...
                                <div class="mb-4">
                                    ...
                                    <input name="creator" value="{{$blog->creator}}" class="w-full rounded border-gray-100 placeholder:text-sm focus:border focus:border-violet-500 focus:ring-0 dark:bg-zinc-700/50 dark:border-zinc-600 dark:placeholder:text-zinc-100 dark:text-zinc-100" type="text" placeholder="فقط حروف انگلیسی" id="example-text-input">
                                </div>

                                <div class="form-group">
                                    <label for="photo">گالری تصاویر</label>
                                    <input type="hidden" name="photo_id"  id="slide-photo">
                                    <input type="hidden" name="image_id" id="slide-image" value="{{$blog->image->id}}">
                                    <div id="photo" class="dropzone" ></div>
                                    <div class="=row">
                                    </div>
                                    <div class="col-sm-3" id="updated_photo_{{$blog->image->id}}">
                                        <img class="img-responsive" src="{{asset('storage/photos/'.$blog->image->path)}}">
                                        <button type="button" class="btn btn-danger" onclick="removeImages({{$blog->image->id}})">حذف</button>
                                    </div>
                                </div>
                                <div class="mt-8">
